...
class FileBackedTasksManagerTest  extends TaskManagerTest{
    ...
    void loadFromFile() {
       ...
       int epicID1 = manager.addEpic(epic);
        ...
        manager1 =   ((FileBackedTasksManager)manager).loadFromFile(file);
    ...
    @Test
    void save() {
        assertDoesNotThrow(()->   ((FileBackedTasksManager)manager).save(),"Сохранение менеджера с пустым списком задач");
        epic = new Epic("Задача 3", "Сделать уроки");
